...
###   This script attempts to download the signature file SHA256SUMS.asc from asacoin.org
...
WORKINGDIR="/tmp/asacoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://asacoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://asacoin.org/bin/"
VERSIONPREFIX="asacoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'asacoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[asacoin-]<version>-[rc[0-9]] (example: asacoin-0.9.2-rc1)"
   echo "wget output:"
