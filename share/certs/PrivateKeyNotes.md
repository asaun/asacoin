...
unlocked to sign the Asacoin-Qt.app bundle.
...
allowing somebody to distribute a Asacoin-Qt.app or asacoin-qt-setup.exe with a valid
...
that the asacoin-qt.exe file inside the installer had not been tampered with.
