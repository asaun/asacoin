Asacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/asacoin/files/Asacoin/asacoin-0.5.4/
...
http://gitorious.org/asacoin/asacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Asacoin-Qt notifications under Growl 1.3.
Increase required age of Asacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAsacoin properly when installing Asacoin-Qt over it. (Windows)
