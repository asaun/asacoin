Asacoin Core version 0.9.4 is now available from:

  https://asacoin.org/bin/0.9.4/
...
this update is incompatible with the Asacoin system and could lead to consensus
forks.

Asacoin Core released binaries from https://asacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~asacoin/+archive/ubuntu/asacoin
- A third-party or self-compiled Asacoin Core

upgrade to Asacoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
