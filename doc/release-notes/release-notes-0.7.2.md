Asacoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/asacoin/files/Asacoin/asacoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Asacoin-Qt to crash on Windows when exiting.
