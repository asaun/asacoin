Download URL: https://sourceforge.net/projects/asacoin/files/Asacoin/asacoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ASA fee schedule (users still pay 0.01 ASA per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #asacoin00 - #asacoin99
