Asacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/asacoin/files/Asacoin/asacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Asacoin
...
New/changed settings (command-line or asacoin.conf file)
--------------------------------------------------------
