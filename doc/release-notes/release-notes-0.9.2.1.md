Asacoin Core version 0.9.2.1 is now available from:

  https://asacoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ASA to 0.01 ASA
...
- Fix "Start asacoin on system login"
