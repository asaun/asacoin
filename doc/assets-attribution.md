The following is a list of assets used in the asacoin source and their proper attribution.
...
* License: MIT
* Site: [https://asacointalk.org/index.php?topic=15276.0](https://asacointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original asacoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/asacoin.icns, src/qt/res/src/asacoin.svg,
	src/qt/res/src/asacoin.ico, src/qt/res/src/asacoin.png,
	src/qt/res/src/asacoin_testnet.png, docs/asacoin_logo_doxygen.png,
