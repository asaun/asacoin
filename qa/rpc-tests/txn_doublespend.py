...
from test_framework import AsacoinTestFramework
...
class TxnMallTest(AsacoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 ASA:
        ...
        # First: use raw transaction API to send 1210 ASA to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50ASA for another
        ...
        # Node0's total balance should be starting balance, plus 100ASA for 
