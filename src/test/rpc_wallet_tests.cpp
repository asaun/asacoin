...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CAsacoinAddress demoAddress = CAsacoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CAsacoinAddress setaccountDemoAddress = CAsacoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CAsacoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CAsacoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
