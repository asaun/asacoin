...
#if defined(NDEBUG)
# error "Asacoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Asacoin Signed Message:\n";
...
CAmount GetBlockValue(int nHeight, const CAmount& nFees)
{
    ...
    if(nHeight == 1){
        CAmount _nSubsidy = 15000000000 * COIN;
        return _nSubsidy;
    }
