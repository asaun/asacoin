...
QT_TRANSLATE_NOOP("asacoin-core", ""
"Cannot obtain a lock on data directory %s. Asacoin Core is probably already "
"running."),
QT_TRANSLATE_NOOP("asacoin-core", ""
...
"hash)"),
QT_TRANSLATE_NOOP("asacoin-core", ""
"Fees (in ASA/Kb) smaller than this are considered zero fee for relaying "
"(default: %s)"),
QT_TRANSLATE_NOOP("asacoin-core", ""
"Fees (in ASA/Kb) smaller than this are considered zero fee for transaction "
"creation (default: %s)"),
QT_TRANSLATE_NOOP("asacoin-core", ""
...
QT_TRANSLATE_NOOP("asacoin-core", ""
"To use asacoind, or the -server option to asacoin-qt, you must set an "
...
QT_TRANSLATE_NOOP("asacoin-core", ""
"Unable to bind to %s on this computer. Asacoin Core is probably already "
"running."),
QT_TRANSLATE_NOOP("asacoin-core", ""
...
"your clock is wrong Asacoin Core will not work properly."),
QT_TRANSLATE_NOOP("asacoin-core", ""
...
QT_TRANSLATE_NOOP("asacoin-core", "(default: 1)"),
QT_TRANSLATE_NOOP("asacoin-core", "<category> can be:"),
QT_TRANSLATE_NOOP("asacoin-core", "Accept command line and JSON-RPC commands"),
QT_TRANSLATE_NOOP("asacoin-core", "Accept connections from outside (default: 1 if no -proxy or -connect)"),
QT_TRANSLATE_NOOP("asacoin-core", "Accept public REST requests (default: %u)"),
QT_TRANSLATE_NOOP("asacoin-core", "Acceptable ciphers (default: %s)"),
QT_TRANSLATE_NOOP("asacoin-core", "Add a node to connect to and attempt to keep the connection open"),
QT_TRANSLATE_NOOP("asacoin-core", "Allow DNS lookups for -addnode, -seednode and -connect"),
QT_TRANSLATE_NOOP("asacoin-core", "Always query for peer addresses via DNS lookup (default: %u)"),
QT_TRANSLATE_NOOP("asacoin-core", "Attempt to recover private keys from a corrupt wallet.dat"),
QT_TRANSLATE_NOOP("asacoin-core", "Block creation options:"),
QT_TRANSLATE_NOOP("asacoin-core", "Cannot downgrade wallet"),
QT_TRANSLATE_NOOP("asacoin-core", "Cannot resolve -bind address: '%s'"),
QT_TRANSLATE_NOOP("asacoin-core", "Cannot resolve -externalip address: '%s'"),
QT_TRANSLATE_NOOP("asacoin-core", "Cannot resolve -whitebind address: '%s'"),
QT_TRANSLATE_NOOP("asacoin-core", "Cannot write default address"),
QT_TRANSLATE_NOOP("asacoin-core", "Connect only to the specified node(s)"),
...
QT_TRANSLATE_NOOP("asacoin-core", "Copyright (C) 2009-%i The Asacoin Core Developers"),
QT_TRANSLATE_NOOP("asacoin-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("asacoin-core", "Could not parse -rpcbind value %s as network address"),
QT_TRANSLATE_NOOP("asacoin-core", "Debugging/Testing options:"),
QT_TRANSLATE_NOOP("asacoin-core", "Disable safemode, override a real safe mode event (default: %u)"),
...
QT_TRANSLATE_NOOP("asacoin-core", "Error loading wallet.dat"),
QT_TRANSLATE_NOOP("asacoin-core", "Error loading wallet.dat: Wallet corrupted"),
QT_TRANSLATE_NOOP("asacoin-core", "Error loading wallet.dat: Wallet requires newer version of Asacoin Core"),
...
QT_TRANSLATE_NOOP("asacoin-core", "Fee (in ASA/kB) to add to transactions you send (default: %s)"),
...
QT_TRANSLATE_NOOP("asacoin-core", "Initialization sanity check failed. Asacoin Core is shutting down."),
QT_TRANSLATE_NOOP("asacoin-core", "Insufficient funds"),
QT_TRANSLATE_NOOP("asacoin-core", "Invalid -onion address: '%s'"),
QT_TRANSLATE_NOOP("asacoin-core", "Invalid -proxy address: '%s'"),
QT_TRANSLATE_NOOP("asacoin-core", "Invalid amount for -maxtxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("asacoin-core", "Invalid amount for -minrelaytxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("asacoin-core", "Invalid amount for -mintxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("asacoin-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("asacoin-core", "Invalid amount for -paytxfee=<amount>: '%s'"),
...
QT_TRANSLATE_NOOP("asacoin-core", "Limit size of signature cache to <n> entries (default: %u)"),
...
QT_TRANSLATE_NOOP("asacoin-core", "RPC SSL options: (see the Asacoin Wiki for SSL setup instructions)"),
...
QT_TRANSLATE_NOOP("asacoin-core", "Send trace/debug info to console instead of debug.log file"),
QT_TRANSLATE_NOOP("asacoin-core", "Send transactions as zero-fee transactions if possible (default: %u)"),
QT_TRANSLATE_NOOP("asacoin-core", "Server certificate file (default: %s)"),
QT_TRANSLATE_NOOP("asacoin-core", "Server private key (default: %s)"),
...
QT_TRANSLATE_NOOP("asacoin-core", "Use OpenSSL (https) for JSON-RPC connections"),
QT_TRANSLATE_NOOP("asacoin-core", "Use UPnP to map the listening port (default: %u)"),
QT_TRANSLATE_NOOP("asacoin-core", "Use UPnP to map the listening port (default: 1 when listening)"),
...
QT_TRANSLATE_NOOP("asacoin-core", "Wallet needed to be rewritten: restart Asacoin Core to complete"),
...
QT_TRANSLATE_NOOP("asacoin-core", "wallet.dat corrupt, salvage failed"),
};
