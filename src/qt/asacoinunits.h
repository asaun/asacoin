...
#ifndef ASACOIN_QT_ASACOINUNITS_H
#define ASACOIN_QT_ASACOINUNITS_H
...
/** Asacoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AsacoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AsacoinUnits(QObject *parent);

    /** Asacoin units.
      @note Source: https://en.asacoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ASA,
...
typedef AsacoinUnits::Unit AsacoinUnit;

#endif // ASACOIN_QT_ASACOINUNITS_H
